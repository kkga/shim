      ...
      >
        {(renderProps) => (
          <>
            ...
            <div
              className={cx(
                "flex flex-col self-stretch border-s border-neutral-border group-data-[disabled]:border-neutral-line"
              )}
            >
              <StepperButton slot="increment">
                <CaretUp aria-hidden size={10} weight="bold" />
              </StepperButton>
              <div className="h-px bg-neutral-border group-data-[disabled]:bg-neutral-line" />
...
function StepperButton(props: ButtonProps) {
  return (
    <Button
      {...props}
      className="flex flex-1 cursor-default items-center justify-center px-[4px] text-neutral-text group-data-[disabled]:text-neutral-placeholder data-[pressed]:bg-neutral-bg-active"
    />
  );
}
