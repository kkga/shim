...
const Label = (props: LabelProps) => (
  <RACLabel
    {...props}
    className={cx(
      "w-fit cursor-default text-xs font-medium text-neutral-text",
      // peer/group disabled
...
const FieldError = (props: FieldErrorProps) => (
  <RACFieldError
    className={cxRenderProps(props.className, "text-[12px] text-error-text")}
    {...props}
  />
);
