...
const style = tv({
  slots: {
    header:
      "col-span-full flex h-6 items-center gap-1.5 px-2 font-medium text-neutral-text-contrast text-sm leading-none",
    item: [
      focusStyle(),
      "flex h-6 items-center gap-2 rounded px-2 text-neutral-text text-sm leading-none",
    ],
  },
  variants: {
    isDisabled: {
...
export function Nav({ navSections }: Props) {
  ...
  return (
    <div className="sticky top-0 z-30 col-start-2 flex flex-col border-neutral-3 bg-background-subtle lg:h-svh lg:border-l">
