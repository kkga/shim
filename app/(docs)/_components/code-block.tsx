...
function CodeHeader({
  ...
  return (
    <div className="sticky top-0 z-20 flex min-h-8 items-center bg-background px-1 py-0">
      {children}
      <CodeActions
...
export function CodeBlock({ onCodeTabChange, ...props }: Props) {
  ...
  return (
    <div
      className={twMerge(
        "codeblock group relative isolate my-8 min-w-0 overflow-clip rounded-lg border border-neutral-3 text-neutral-text text-xs leading-normal",
        props.className
      )}
    >
